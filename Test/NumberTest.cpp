...
TEST( NumberTest, Read4ByteIntger )
{
  ...
  EXPECT_EQ( 67305985, ReadNumber( number, 4 ) );
}
...
TEST( NumberTest, Read8ByteIntger )
{
  ...
  EXPECT_EQ( 578437695752307201, ReadNumber( number, 8 ) );
}

TEST( NumberTest, Write4ByteInteger )
{
  uint8_t number[4];
  WriteNumber( 67305985, number, 4 );
...
{
  uint8_t number[8];
  WriteNumber( 578437695752307201, number, 8 );
